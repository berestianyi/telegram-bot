...
from utils.utils import name_split, name_cut, month_names, \
    car_data, car_quantity, today_date, date_to_dict, is_man_for_fop, is_man_for_tov, is_woman_for_tov, is_fop

#
# def roland_doc(user_info):
#
#     if is_fop(user_info["code"]):
#         if user_info["atp_choice"] == "roland_d":
#             doc = Document('files/roland_d_fop.docx')
#         else:
#             doc = Document('files/roland_h_fop.docx')
...
#     else:
#         if user_info["atp_choice"] == "roland_d":
#             doc = Document('files/roland_d_tov.docx')
#         else:
#             doc = Document('files/roland_h_tov.docx')
#
#         if is_man_for_tov(user_info['name'], 'files/man_names.txt'):
#             sho = "який"
#         elif is_woman_for_tov(user_info['woman'], 'files/woman_names.txt'):
#             sho = "яка"
#         else:
#             sho = "що"
#
...
#
#     quantity = car_quantity(user_info["vehicle_data"])
#     cars_data = car_data(user_info["vehicle_data"], quantity)
#
...
#                                   " в особі Директора " + user_info["tov_name"].upper() + ", ").bold = True
...
#
#     if is_tov:
#         doc = Document('files/royal_tov.docx')
#         if is_man_for_tov(user_info['name'], 'files/man_names.txt'):
#             sho = "який"
#         elif is_woman_for_tov(user_info['woman'], 'files/woman_names.txt'):
#             sho = "яка"
...
#             sho = "що"
#     else:
#         doc = Document('files/royal_fop.docx')
#         if is_man_for_fop(user_info["code"]):
#             sho = "який"
#         else:
#             sho = "яка"
...
#         doc.paragraphs[3].add_run(user_info["tov_name"].upper() + ", ").bold = True
